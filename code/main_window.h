...
//    Mat screen;
    ...
    //    bool show_hidden = false;
        ...
        Button *Bigeye_Button = new Button();//mia
    ...
    //    QSpinBox *brightness_spinBox = new QSpinBox();
    //    QSlider *brightness_slider = new QSlider(Qt::Horizontal);
     ...
     //color_filter Red-1, Orange-2, Yellow-3, Green-4, Blue-5, Purple-6, Pink-7
    ...
    private slots:
     ...
     /*Tool*/
        ...
        void Hide_Bright_Slider();//mia
        void Show_Bright_Slider();//mia

        void Hide_Contrast_Slider();//mia
        void Show_Contrast_Slider();//mia
        ...
        void Hide_Blur_Slider();//mia
        void Show_Blur_Slider();//mia
    ...
    /*Filter*/
        void Set_Filter();//mia
        void Hide_Filter();//mia
        void Show_Filter();//mia
        void Filter();
    ...
    //    void Hide_Sticker_Slider();//mia
    //    void Show_Sticker_Slider();//mia
    /*big eye*/
        void Show_eyeSlider();
        void Hide_eyeSlider();
        void temp_BigEye();
